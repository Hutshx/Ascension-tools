...
assert(oUF, "oUF_HealComm was unable to locate oUF install")

local healpredict = _G.HealPredict
assert(healpredict, "oUF_HealComm was unable to locate HealPredict")
...
-- Register the element with oUF
oUF:AddElement('HealComm', Path, Enable, Disable)
